...
namespace AltaTest.Controllers
{
    ...
    public class AltaTestController : ControllerBase
    {
        ...
        public IEnumerable<View01> Get()
        {
            ...
            query.Append("ROW_NUMBER() OVER (ORDER BY sum(b.point) DESC, max(b.DateTime), a.Name, b.PlayerId) AS STT, ");
            ...
            view01s = _context.Database.SqlQuery<View01>(query.ToString());
            return view01s;
        }
    }
}
